        ...
        <div class="container">
            <div class="row ">
                ...
                <div class="col-md-4 col-sm-4 comp-grid">
                    <?php $rec_count = $comp_model->getcount_optometrypapers();  ?>
                    <a class="animated zoomIn record-count alert alert-info"  href="<?php print_link("optometry_papers/") ?>">
                        <div class="row">
                            <div class="col-2">
                            ...
                            <div class="col-10">
                                <div class="flex-column justify-content align-center">
                                    <div class="title">Optometry Papers</div>
                                    ...
                                    <small class="small desc">Optometry Test Papers</small>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-10">
                                <div class="flex-column justify-content align-center">
                                    ...
                                    <small class="small desc">Get KTMC Notes</small>
                                </div>
                            </div>
                            <h4 class="value"><strong><?php echo $rec_count; ?></strong></h4>
                        </div>
