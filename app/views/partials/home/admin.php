    ...
    <div  class="">
        <div class="container">
            <div class="row ">
                        ...
                        <div class="row">
                            ...
                            <div class="col-10">
                                <div class="flex-column justify-content align-center">
                                    ...
                                    <small class="small desc">All KMTC notes</small>
                                </div>
                            </div>
                ...
                <div class="col-md-4 col-sm-4 comp-grid">
                    <?php $rec_count = $comp_model->getcount_notice();  ?>
                    <a class="animated zoomIn record-count alert alert-info"  href="<?php print_link("notice/") ?>">
                        <div class="row">
                            <div class="col-2">
                            ...
                            <div class="col-10">
                                <div class="flex-column justify-content align-center">
                                    ...
                                    <small class="small desc">Notices</small>
                                </div>
                            </div>
                            <h4 class="value"><strong><?php echo $rec_count; ?></strong></h4>
                        </div>
