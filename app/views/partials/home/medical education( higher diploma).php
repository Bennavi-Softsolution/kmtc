        ...
        <div class="container">
            <div class="row ">
                <div class="col-md-4 col-sm-4 comp-grid">
                    <?php $rec_count = $comp_model->getcount_mepapers();  ?>
                    <a class="animated zoomIn record-count alert alert-info"  href="<?php print_link("me_papers/") ?>">
                        <div class="row">
                            <div class="col-2">
                            ...
                            <div class="col-10">
                                <div class="flex-column justify-content align-center">
                                    ...
                                    <small class="small desc">Medical Education Test Papers</small>
                                </div>
                            </div>
