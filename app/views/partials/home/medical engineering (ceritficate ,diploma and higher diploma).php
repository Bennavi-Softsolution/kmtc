        ...
        <div class="container">
            <div class="row ">
                ...
                <div class="col-md-4 col-sm-4 comp-grid">
                    <?php $rec_count = $comp_model->getcount_medengpapers();  ?>
                    <a class="animated zoomIn record-count alert alert-info"  href="<?php print_link("medeng_papers/") ?>">
                        <div class="row">
                            <div class="col-2">
                            ...
                            <div class="col-10">
                                <div class="flex-column justify-content align-center">
                                    <div class="title">Medeng Papers</div>
                                    ...
                                    <small class="small desc">Medical Engineering Test Papers</small>
                                </div>
                            </div>
                ...
                <div class="col-md-4 col-sm-4 comp-grid">
                    ...
                    <a class="animated zoomIn record-count alert alert-success"  href="<?php print_link("search_notes/") ?>">
                        <div class="row">
                            <div class="col-2">
