        ...
        <div class="container">
            <div class="row ">
                ...
                <div class="col-md-4 col-sm-4 comp-grid">
                    <?php $rec_count = $comp_model->getcount_cmspapers();  ?>
                    <a class="animated zoomIn record-count alert alert-info"  href="<?php print_link("cms_papers/") ?>">
                        <div class="row">
                            <div class="col-2">
                            ...
                            <div class="col-10">
                                <div class="flex-column justify-content align-center">
                                    <div class="title">Cms Papers</div>
                                    ...
                                    <small class="small desc">Clinical Medicine and Surgery Papers</small>
                                </div>
                            </div>
