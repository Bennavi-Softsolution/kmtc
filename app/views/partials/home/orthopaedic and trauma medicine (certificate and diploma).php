        ...
        <div class="container">
            <div class="row ">
                ...
                <div class="col-md-4 col-sm-4 comp-grid">
                    <?php $rec_count = $comp_model->getcount_otmpapers();  ?>
                    <a class="animated zoomIn record-count alert alert-info"  href="<?php print_link("otm_papers/") ?>">
                        <div class="row">
                            <div class="col-2">
                            ...
                            <div class="col-10">
                                <div class="flex-column justify-content align-center">
                                    <div class="title">Otm Papers</div>
                                    ...
                                    <small class="small desc">Orthopaedics and Trauma Medicine Test papers</small>
                                </div>
                            </div>
                ...
                <div class="col-md-4 col-sm-4 comp-grid">
                    ...
                    <a class="animated zoomIn record-count alert alert-success"  href="<?php print_link("questions_answers/") ?>">
                        <div class="row">
                            <div class="col-2">
                            ...
                            <div class="col-10">
                                <div class="flex-column justify-content align-center">
                                    ...
                                    <small class="small desc">Questions and Answere</small>
                                </div>
                            </div>
                            <h4 class="value"><strong><?php echo $rec_count; ?></strong></h4>
                        </div>
                ...
                <div class="col-md-4 col-sm-4 comp-grid">
                    ...
                    <a class="animated zoomIn record-count alert alert-info"  href="<?php print_link("search_notes/") ?>">
                        <div class="row">
                            <div class="col-2">
