...
<section class="page" id="<?php echo $page_element_id; ?>" data-page-type="list"  data-display-type="grid" data-page-url="<?php print_link($current_page); ?>">
    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container-fluid">
            <div class="row ">
                <div class="col ">
                    <h4 class="record-title">Questions Answers</h4>
                </div>
                <div class="col-sm-3 ">
                    <?php if($can_add){ ?>
                        ...
                        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                            <div class="modal-content">
                                <div class="modal-body p-0 reset-grids">
                                    <div class=" ">
                                        <?php  
                                        $this->render_page("questions_answers/add"); 
                                        ?>
                                    </div>
                                </div>
                ...
                <div class="col-sm-4 ">
                    <form  class="search" action="<?php print_link('questions_answers'); ?>" method="get">
                            ...
                            <nav class="page-header-breadcrumbs mt-2" aria-label="breadcrumb">
                                <ul class="breadcrumb m-0 p-1">
                                    ...
                                    <li class="breadcrumb-item">
                                        <a class="text-decoration-none" href="<?php print_link('questions_answers'); ?>">
                ...
                <div class="row ">
                    <div class="col-md-12 comp-grid">
                        ...
                        <div  class=" animated fadeIn page-content">
                            <div id="questions_answers-list-records">
                                <?php
                                if(!empty($records)){
                                ?>
                                <div id="page-report-body">
                                    <div class="row sm-gutters page-data" id="page-data-<?php echo $page_element_id; ?>">
                                        ...
                                        ?>
                                        <div class="col-sm-12">
                                            <div class="bg-light p-2 mb-3 animated bounceIn" style="border-radius:20px;">
                                                ...
                                                <div class="card">
                                                    <div class="card-body">
                                                        ...
                                                        <div class="mb-2" alt=".">  <?php Html :: page_img($data['image1'],300,300,1); ?></div>
                                                        <!--quiz ends here-->
                                                        <!--answer starts here-->
                                                        <font size="3px;">                      <p>
                                                            <div class="mb-2">  
                                                    ...
                                                    <div class="mb-2">  <?php Html :: page_img($data['image2'],300,300,1); ?></div>
                                                    <!--answer ends here-->
                                                </div>
                                            </div>
                            ...
                            <div class="text-muted  animated bounce p-3">
                                <h4><i class="icon-ban"></i> No questions or answer found</h4>
                            </div>
                            <?php
                            }
                            ?>
