...
class IndexController extends BaseController{
	...
	function index(){
		if(user_login_status() == true){
			$this->redirect(HOME_PAGE);
		    	...
		    	$page_title = $this->view->page_title = "Welcome To Kmtc Testa - where Kmct students can Access test papers ,notes , and Questions with answers.";
	...
	function register($formdata = null){
		if($formdata){
			...
			$db = $this->GetModel();
			$tablename = $this->tablename;
			$fields = $this->fields = array("username","email","phone","image","role","password"); //registration fields
			...
			$date_to_expire = format_date("2 years");
		...
		$page_title = $this->view->page_title = "Register New User";
